...
import { ChainId } from '@iethereum/sdk';
...
var links = [
    ...
    },
    {
        ...
        icon: "ShieldIcon",
        href: "https://twitter.com/iethereum/status/1367218225310818308",
        target: "_blank",
    },
    {
        label: "Bush",
    ...
    },
    {
        ...
        items: [
            ...
            {
                label: "Github",
                href: "https://github.com/iEthereumFinance/",
                target: '_blank',
            },
            {
                label: "Docs",
                href: "https://iEthereumFinance.gitbook.io/iethereum/",
            },
            {
                label: "Blog",
                href: "https://iethereum.medium.com/",
            },
        ],
    },
];
var socials = [
    {
        label: "Telegram",
        icon: "TelegramIcon",
        href: "https://t.me/iethereum",
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/iethereum",
    },
];
var MENU_HEIGHT = 64;
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { primary: "#ff4e91", secondary: "#ff4e91", background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", 
    // inputBorder: "#cccccc",
    inputSecondary: "#cccccc", tertiary: "#EFF4F5", text: "#b64c61", textDisabled: "#BDC2C4", textSubtle: "#ff0069", activeButton: "#397f49", borderColor: "#E9EAEB", card: "#FFFFFF", nav: "#FFFFFF", gradients: {
        bubblegum: "linear-gradient(139.73deg, #fde6eb 0%, #fff8fa 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { primary: "#FFC737", secondary: "#FFC737", background: "#2A2829", backgroundDisabled: "#424037", contrast: "#FFFFFF", invertedContrast: "#262513", input: "#483F5A", inputSecondary: "#8d8857", primaryDark: "#8f8104", tertiary: "#28444A", text: "#fcfae2", textDisabled: "#717161", textSubtle: "#FFC737", activeButton: "#397f49", borderColor: "#61634b", card: "#171813", nav: "#171813", gradients: {
